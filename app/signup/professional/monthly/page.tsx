...
export default function ProfessionalMonthlySignupPage() {
  ...
  const handlePaymentComplete = (paymentMethod: string, paymentDetails: any) => {
    ...
    // In a real app, you would process the subscription on the server
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold mb-4">Subscribe to Professional Plan (Monthly)</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">Ideal for growing organizations - $49/month</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        {step === "details" ? (
          <Card className="p-6">
            <CardHeader className="p-0 mb-6">
              <CardTitle className="text-2xl mb-2">Account Details</CardTitle>
          ...
          <Card className="p-6">
            ...
            <CardContent className="p-0">
              <PaymentProvider onPaymentComplete={handlePaymentComplete} amount={49} />
            </CardContent>
        ...
        <div>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-100">
            ...
            <p className="text-blue-700 text-sm mb-4">Switch to annual billing and save 20% ($118/year)</p>
            <Button variant="outline" asChild>
              <Link href="/signup/professional/annual">Switch to Annual Plan</Link>
            </Button>
          </div>
        </div>
      </div>
